...
import java.sql.*;  
 ...
 public class AddClient extends JFrame implements ActionListener{
	  ...
	  //  JMenuItem t9=new JMenuItem("删除员工信息") ;//菜单项
	 	...
	 	JLabel jlb1=new JLabel("客户姓名:",JLabel.CENTER);
	 	JLabel jlb6=new JLabel("性别:",JLabel.CENTER);
	 	JLabel jlb2=new JLabel("身份证号码:",JLabel.CENTER);
	 	JLabel jlb3=new JLabel("联系电话:",JLabel.CENTER);
	 	JLabel jlb4=new JLabel("房间号:",JLabel.CENTER);
	 	JLabel jlb5=new JLabel("房间类型:",JLabel.CENTER);
